...
export interface mariadb {
  version: string;
  createConnection(connectionUri: string | ConnectionConfig): Promise<Connection>;
  createPool(config: PoolConfig | string): Pool;
...
export interface Connection {
   ...
   */
  queryStream(sql: string | QueryOptions, values?: any): any;
