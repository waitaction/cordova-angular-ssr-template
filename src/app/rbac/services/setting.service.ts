...
//     return JSON.parse(this.universalStorageService.getItem("local_" + key) || 'null') || null;
//   }
...
//     this.universalStorageService.setItem("local_" + key, JSON.stringify(value));
//   }
...
//     return JSON.parse(this.universalStorageService.getItem("session_" + key) || 'null') || null;
//   }
...
//     this.universalStorageService.setItem("session_" + key, JSON.stringify(value))
...
//     this.universalStorageService.removeItem("local_" + key);
//   }
...
//     this.universalStorageService.removeItem("session_" + key);
//   }
