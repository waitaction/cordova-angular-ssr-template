...
import { NavService } from 'admin/ui/services/nav.service';
import { AuthService } from 'admin/ui/services/auth.service';
import { ConfigService } from 'admin/ui/services/config.service';
...
export class TabsComponent  implements OnInit {
  ...
  tab(index: number) {
    ...
    if (tab && tab.router) {
      ...
      this.router.navigate([`/admin/index/${page}`, param]);
    }
  }
  ...
  close(tab: Menu) {
    ...
    ReuseStrategyService.deleteRouteSnapshot(`/index/${tab.router}`);
